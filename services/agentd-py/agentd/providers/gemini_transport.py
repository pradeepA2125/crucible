...
class GeminiJsonTransport(ModelJsonTransport):
    def __init__(
        ...
        *,
        ...
        # is uncertain — the older "deadlocks on oneOf" note predates response_json_schema
        # and no live test confirms strict oneOf enforcement. anyOf gives per-variant
        # token-level enforcement without the mutual-exclusion overhead, which is safer.
