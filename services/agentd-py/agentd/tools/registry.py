...
class ToolRegistry:
    ...
    All file-system operations are sandboxed to shadow_root.  Semantic search
    is only available when a SemanticIndex instance is provided.
    """
    ...
    def __init__(
        ...
        allowlist_raw = os.environ.get(
            ...
            "pytest,npm,cargo,ruff,mypy,tsc,eslint",
        )
    ...
    def definitions(self) -> list[ToolDefinition]:
        tools = [
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "path_filter": {
                            "type": "string",
                            "description": "Optional glob to restrict search (e.g. '*.py', 'src/**/*.ts')",
                        },
                        "context_lines": {
                            "type": "integer",
            ...
            ToolDefinition(
                name="run_command",
                description=(
                    "Run an allow-listed shell command inside the workspace. "
