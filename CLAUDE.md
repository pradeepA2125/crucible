...
agentskills.io `SKILL.md` skills: an always-on catalog + model-driven progressive disclosure. Flag-gated, **default OFF** (`AI_EDITOR_SKILLS_ENABLED`), **controller-only**. Spec/plan: `docs/superpowers/specs/2026-06-30-agent-skills-design.md` + `…/plans/2026-06-30-agent-skills.md`. Grounded in a survey of Claude Code/Codex/opencode impls (all implement the same open standard).
