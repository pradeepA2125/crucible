...
const transitions: Record<TaskStatus, ReadonlySet<TaskStatus>> = {
  ...
  EXECUTING: new Set(["VALIDATING", "AWAITING_SCOPE_DECISION", "AWAITING_STEP_REVIEW", "AWAITING_COMMAND_DECISION", "FAILED", "ABORTED"]),
  AWAITING_SCOPE_DECISION: new Set(["EXECUTING", "FAILED", "ABORTED"]),
  AWAITING_STEP_REVIEW: new Set(["EXECUTING", "FAILED", "ABORTED"]),
  AWAITING_COMMAND_DECISION: new Set(["EXECUTING", "FAILED", "ABORTED"]),
  VALIDATING: new Set(["VALIDATED", "REPAIRING", "AWAITING_VALIDATION_DECISION", "FAILED", "ABORTED"]),
  REPAIRING: new Set(["EXECUTING", "VALIDATING", "FAILED", "ABORTED"]),
  AWAITING_VALIDATION_DECISION: new Set(["VALIDATED", "FAILED", "ABORTED"]),
