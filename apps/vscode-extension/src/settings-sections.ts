...
// aiEditor.openSettingsPanel command. The ids mirror the webview SectionId union
 ...
 * The aiEditor.openSettingsPanel command is invoked both from the tree (a valid
